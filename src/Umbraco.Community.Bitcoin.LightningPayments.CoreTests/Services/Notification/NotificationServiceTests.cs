...
public class NotificationServiceTests : IDisposable
{
    ...
    public NotificationServiceTests()
    {
        ...
        _emailHandlerMock.Setup(h => h.SendAsync(It.IsAny<PaymentNotification>(), It.IsAny<CancellationToken>()))
        ...
        _webhookHandlerMock.Setup(h => h.SendAsync(It.IsAny<PaymentNotification>(), It.IsAny<CancellationToken>()))
            .ReturnsAsync(NotificationDeliveryResult.Succeeded());
    ...
    {
        // Arrange - use email-only options so only 1 notification created
        var emailOnlyOptions = CreateOptions(enabled: true, emailEnabled: true, webhookEnabled: false);
        var sut = new NotificationService(_context,
            new[] { _emailHandlerMock.Object, _webhookHandlerMock.Object }, emailOnlyOptions, _loggerMock.Object);
        ...
        // Act
        await sut.SendNotificationAsync("hash_retry", NotificationEvent.PaymentConfirmed);
