namespace Umbraco.Community.Bitcoin.LightningPayments.Core.Services.Breez
{
    ...
    public interface IBreezSdkService : IAsyncDisposable
    {
        ...
        /// <summary>
        /// Attempts to parse a BOLT11 invoice and extract its global::Breez.Sdk.Liquid.Payment hash.
        /// </summary>
        ...
        /// <summary>
        /// Retrieves a global::Breez.Sdk.Liquid.Payment by its global::Breez.Sdk.Liquid.Payment hash.
        /// </summary>
        Task<global::Breez.Sdk.Liquid.Payment?> GetPaymentByHashAsync(string paymentHash, CancellationToken ct = default);

        /// <summary>
        /// Retrieves a list of payments from the Breez SDK for history/display purposes.
        /// </summary>
        Task<List<global::Breez.Sdk.Liquid.Payment>> GetPaymentsAsync(CancellationToken ct = default);
