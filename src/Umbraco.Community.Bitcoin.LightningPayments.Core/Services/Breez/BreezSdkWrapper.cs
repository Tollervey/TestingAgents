...
namespace Umbraco.Community.Bitcoin.LightningPayments.Core.Services.Breez
{
    ...
    public class BreezSdkWrapper : IBreezSdkWrapper
    {
        ...
        /// <summary>
        /// Parses user input into a typed global::Breez.Sdk.Liquid.Payment target (BOLT11/BOLT12/LNURL/BIP21/addresses).
        ...
        /// <summary>
        /// Prepare a receive global::Breez.Sdk.Liquid.Payment for the given method (BOLT11, BOLT12, Bitcoin/Liquid). Returns fees and preparation data.
        /// </summary>
        ...
        /// <summary>
        /// Prepare a send global::Breez.Sdk.Liquid.Payment for any supported input. Use this to present fees/limits before asking for confirmation.
        /// </summary>
        ...
        /// </summary>
        public Task<List<global::Breez.Sdk.Liquid.Payment>> ListPaymentsAsync(BindingLiquidSdk sdk, ListPaymentsRequest request, CancellationToken ct = default)
        => Task.Run(() => sdk.ListPayments(request), ct);

        /// <summary>
        /// Fetch a single global::Breez.Sdk.Liquid.Payment (by hash or swap id). Use for a details page.
        /// </summary>
        public Task<global::Breez.Sdk.Liquid.Payment?> GetPaymentAsync(BindingLiquidSdk sdk, GetPaymentRequest request, CancellationToken ct = default)
