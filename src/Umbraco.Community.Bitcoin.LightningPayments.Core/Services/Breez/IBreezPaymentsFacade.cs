...
namespace Umbraco.Community.Bitcoin.LightningPayments.Core.Services.Breez
{
    ...
    public interface IBreezPaymentsFacade
    {
        ...
        Task<List<global::Breez.Sdk.Liquid.Payment>> ListPaymentsAsync(ListPaymentsRequest request, CancellationToken ct = default);
        Task<global::Breez.Sdk.Liquid.Payment?> GetPaymentAsync(GetPaymentRequest request, CancellationToken ct = default);
