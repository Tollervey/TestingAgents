...
using Umbraco.Community.Bitcoin.LightningPayments.Core.Components;
using Umbraco.Community.Bitcoin.LightningPayments.Core.Features.Paywall.Middleware;
using Umbraco.Community.Bitcoin.LightningPayments.Core.Features.Paywall.Notifications;
...
public class LightningPaymentsComposer : IComposer
{
    ...
    public void Compose(IUmbracoBuilder builder)
    {
        ...
        // Register notification handler for content events
        builder.AddNotificationAsyncHandler<ContentPublishedNotification, PaywallMessageNotificationHandler>();
        ...
        builder.Services.Configure<UmbracoPipelineOptions>(options =>
        {
            options.AddFilter(new UmbracoPipelineFilter("LightningPayments")
            {
                ...
                // No Endpoints mapping here ï¿½ the host app will map health checks.
            });
        });
