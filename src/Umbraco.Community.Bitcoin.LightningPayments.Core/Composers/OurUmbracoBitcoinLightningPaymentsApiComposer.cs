...
namespace Umbraco.Community.Bitcoin.LightningPayments.Core.Composers
{
    public class OurUmbracoBitcoinLightningPaymentsApiComposer : IComposer
    {
        public void Compose(IUmbracoBuilder builder)
        {
            ...
            builder.Services.Configure<SwaggerGenOptions>(opt =>
            {
                ...
                // Include only our controllers in this Swagger document
                opt.DocInclusionPredicate((docName, apiDescription) =>
                {
                    ...
                    {
                        return controllerActionDescriptor.ControllerTypeInfo.Namespace?.StartsWith("Umbraco.Community.Bitcoin.LightningPayments.Core.Api", StringComparison.InvariantCultureIgnoreCase) is true;
                    }
                    return false;
                });
        ...
        public class CustomOperationHandler : OperationIdHandler
        {
            ...
            {
                return controllerActionDescriptor.ControllerTypeInfo.Namespace?.StartsWith("Umbraco.Community.Bitcoin.LightningPayments.Core.Api", comparisonType: StringComparison.InvariantCultureIgnoreCase) is true;
            }
