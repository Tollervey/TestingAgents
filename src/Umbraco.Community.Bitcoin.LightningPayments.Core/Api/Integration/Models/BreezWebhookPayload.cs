using Umbraco.Community.Bitcoin.LightningPayments.Core.Services.Invoice.Models;
using System.Text.Json.Serialization;

namespace Umbraco.Community.Bitcoin.LightningPayments.Core.Api.Integration.Models
{
    /// <summary>
