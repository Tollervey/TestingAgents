...
[Route("umbraco/management/api/lightningpayments")]
...
public class LightningPaymentsApiController : ManagementApiControllerBase
{
    ...
    public async Task<IActionResult> GetAllPayments()
    {
        ...
        {
            return Error(StatusCodes.Status401Unauthorized, "unauthorized", "User not authenticated.");
        }
    ...
    public IActionResult DiagnosticsAssets()
    {
        ...
        var packageId =
            "Umbraco.Community.Bitcoin.LightningPayments"; // This should match your <PackageId> in the .csproj
        ...
        var locations = new[]
        {
            new { label = "site-wwwroot", basePath = "App_Plugins/Umbraco.Community.Bitcoin.LightningPayments" },
            new
            {
                label = "static-web-assets:assembly",
                basePath = $"_content/{assemblyName}/App_Plugins/Umbraco.Community.Bitcoin.LightningPayments"
            },
            new
            {
                label = "static-web-assets:package",
                basePath = $"_content/{packageId}/App_Plugins/Umbraco.Community.Bitcoin.LightningPayments"
            }
        };
